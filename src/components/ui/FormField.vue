<template>
  <div>
    ...
    <input
      ...
      class="ignore-drag w-full px-1.5 py-1 border border-gray-300 dark:border-[#555] dark:bg-[#1f1f1f] dark:text-white rounded text-[13px] box-border focus:outline-none focus:border-[#d2b38c] focus:shadow-[0_0_0_2px_rgba(210,179,140,0.2)]"
