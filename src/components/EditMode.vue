  ...
  <div class="flex flex-col flex-1">
    ...
    <div ref="sortableContainer" class="flex flex-col overflow-y-auto max-h-[300px] px-3 mb-[72px]">
      <div
        ...
        class="flex flex-col items-stretch p-4 mb-1.5 bg-white/80 dark:bg-[#2a2a2a] rounded-lg transition-all duration-200 border border-transparent dark:border-[#393939] cursor-move hover:bg-white/90 dark:hover:bg-[#2d2d2d]"
      >
